...
`gozer` allows you to attach  a 'destructor' artefact (either a string or a function) 
to an R object.

When the R object is destroyed (i.e. garbage collected) the 'destructor' artefact
is printed or called.
